...
public class Toaster {
	...
	public static void main(String[] args) {
		...
		int numOfToasters = in.nextInt();
		int maxWeight = in.nextInt();
		int[] toasterWeights = new int[numOfToasters];
		int[] toasterValues = new int[numOfToasters];
		for (int i = 0; i < toasterWeights.length; i++) {
			toasterWeights[i] = in.nextInt();
			toasterValues[i] = in.nextInt();
		}
		System.out.println(Toaster.knapsack(toasterValues, toasterWeights, maxWeight));
	}
}
